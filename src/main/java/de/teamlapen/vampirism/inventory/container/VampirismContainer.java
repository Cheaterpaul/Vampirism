...
public class VampirismContainer extends InventoryContainer implements TaskContainer {
    ...
    private static final SelectorInfo[] SELECTOR_INFOS = new SelectorInfo[]{
            new SelectorInfo(stack -> stack.getItem() instanceof IRefinementItem && ((IRefinementItem) stack.getItem()).getSlotType() == IRefinementItem.EquipmentSlotType.AMULET, 58, 8),
            new SelectorInfo(stack -> stack.getItem() instanceof IRefinementItem && ((IRefinementItem) stack.getItem()).getSlotType() == IRefinementItem.EquipmentSlotType.RING, 58, 26),
            new SelectorInfo(stack -> stack.getItem() instanceof IRefinementItem && ((IRefinementItem) stack.getItem()).getSlotType() == IRefinementItem.EquipmentSlotType.OBI_BELT, 58, 44)};
